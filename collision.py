...
collision_router[ ('ball', 'pig') ] = collision_ball_block
collision_router[('ball','rotating block')]=collision_ball_rotating_block
def collision(ball,thing,dt):
	'''The collision function takes ball, thing and dt as parameters and has no return value. It is used to call corresponding functions with specified key.'''
